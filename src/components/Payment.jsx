            ...
            <div className="mx-auto flex flex-col justify-center items-center min-h-screen mt-10 md:mt-20 mb-2">
                <div className="bg-[#FFF5EE] p-8 rounded-lg shadow-md w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="amount_paid" className="block font-semibold mb-2">
                                Amount:
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label htmlFor="currency" className="block font-semibold mb-2">
                                Currency:
                            </label>
                            <select
                                id="currency"
            ...
            <div className="container mx-auto px-4 mb-10">
                <div className="bg-gray-100 p-6 rounded-lg shadow-md">
                    ...
                    <ul className="list-disc list-inside mt-2 text-gray-700">
                        <li>
                            <strong>Correct Information:</strong> Double-check your currency selection and email
                            address.
                        </li>
                        <li>
                            <strong>Transaction Time:</strong> Deposits may take up to 24 hours to reflect.
                        </li>
                        <li>
                            <strong>Fees and Limits:</strong> Be aware of transaction fees or limits.
                        </li>
                        <li>
                            <strong>Security:</strong> Ensure your connection is secure.
                        </li>
                    </ul>
