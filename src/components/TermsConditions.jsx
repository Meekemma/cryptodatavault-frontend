...
const TermsConditions = () => {
  ...
  return (
    <div className="container mx-auto p-8">
      ...
      <p className="text-gray-700"><strong>Last Updated:</strong> [Date]</p>
      <p>Welcome to [Platform Name]! These Terms and Conditions ("Terms") govern your access and use of our crypto investment platform. By accessing or using our platform, you agree to comply with and be bound by these Terms. If you do not agree with these Terms, please do not use our platform.</p>
      ...
      <ul className="list-disc pl-6">
        <li>All content, logos, and trademarks on the platform are the property of [Platform Name] and are protected by intellectual property laws.</li>
      ...
      <p>You agree to indemnify and hold [Platform Name], its affiliates, and their respective officers, directors, and employees harmless from any claims, losses, or damages arising from your use of the platform or violation of these Terms.</p>
      
      <h2 className="text-2xl font-bold mt-6">16. Governing Law and Dispute Resolution</h2>
      <ul className="list-disc pl-6">
        <li>These Terms are governed by the laws of [Country/Region].</li>
      ...
      <p>For any questions or concerns regarding these Terms, please contact us at [Support Email].</p>
    </div>
  );
};
